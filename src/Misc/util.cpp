...
void debugData(controller &x360Controller) {
	...
	while (true) {
		...
		if ((bool)(x360Controller.inputBuffer[8 + x360Controller.hidOffset] & (1 << 4))) DEBUG("Square Button");

		if ((bool)(x360Controller.inputBuffer[8 + x360Controller.hidOffset] & (1 << 5))) DEBUG("Cross Button");

		if ((bool)(x360Controller.inputBuffer[8 + x360Controller.hidOffset] & (1 << 6))) DEBUG("Circle Button");

		if ((bool)(x360Controller.inputBuffer[8 + x360Controller.hidOffset] & (1 << 7))) DEBUG("Triangle Button");

		if ((bool)(x360Controller.inputBuffer[9 + x360Controller.hidOffset] & (1 << 0))) DEBUG("L1 Button");

		if ((bool)(x360Controller.inputBuffer[9 + x360Controller.hidOffset] & (1 << 1))) DEBUG("R1 Button");

		if ((bool)(x360Controller.inputBuffer[9 + x360Controller.hidOffset] & (1 << 4))) DEBUG("Select Button");

		if ((bool)(x360Controller.inputBuffer[9 + x360Controller.hidOffset] & (1 << 5))) DEBUG("Start Button");

		if ((bool)(x360Controller.inputBuffer[9 + x360Controller.hidOffset] & (1 << 6))) DEBUG("L3 Button");

		if ((bool)(x360Controller.inputBuffer[9 + x360Controller.hidOffset] & (1 << 7))) DEBUG("R3 Button");

		if ((bool)(x360Controller.inputBuffer[10 + x360Controller.hidOffset] & (1 << 0))) DEBUG("Sony/Home Button");

		if ((bool)(x360Controller.inputBuffer[10 + x360Controller.hidOffset] & (1 << 1))) DEBUG("Touchpad Button");

		if ((bool)(x360Controller.inputBuffer[10 + x360Controller.hidOffset] & (1 << 2))) DEBUG("Mic Button");
